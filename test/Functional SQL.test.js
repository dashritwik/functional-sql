...
const Test ={
  assertSimilar:(a,b,message)=>{
    expect(a).to.deep.equal(b,message);
  },
  expect:(a)=>{
...
describe("SQL tests", function() {
    ...
    it('GROUP BY tests', function() {
      ...
      Test.assertSimilar(query().select().from(persons).groupBy(profession, name).execute(),  [["teacher",
      [["Peter",[{"name":"Peter","profession":"teacher","age":20,"maritalStatus":"married"},
      {"name":"Peter","profession":"teacher","age":20,"maritalStatus":"married"}]],
      ["Michael",[{"name":"Michael","profession":"teacher","age":50,"maritalStatus":"single"}]]]],
      ["scientific",
      [["Anna",[{"name":"Anna","profession":"scientific","age":20,"maritalStatus":"married"},
      {"name":"Anna","profession":"scientific","age":20,"maritalStatus":"single"}]],
